# Generated by Django 4.2.1 on 2024-01-31 01:22

from django.db import migrations


def backfill_accounting_fields(apps, schema_editor):
    from hordak.models.core import Leg, Account
...
class Migration(migrations.Migration):
    dependencies = [
        ("hordak", "0038_leg_account_type_leg_accounting_amount_and_more"),
    ]

    operations = [migrations.RunPython(backfill_accounting_fields)]
